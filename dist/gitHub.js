[
// src/gitHub/1000hz/bootstrap-validator.js
{
    properties: {
        examples: [
            'http://1000hz.github.io/bootstrap-validator/',
            'https://account.kansascity.com/olive-auth'
        ],
        link: 'https://github.com/1000hz/bootstrap-validator',
...
// src/gitHub/Adobe-Marketing-Cloud/dil.js
{
    properties: {
        ...
        name: 'Adobe Data Integration Library',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/AudithSoftworks/Uniform.js
{
    properties: {
        examples: [
            'http://opensource.imanov.net/uniform/'
        ],
        link: 'https://github.com/AudithSoftworks/Uniform',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/Chevereto/Chevereto-Free.js
{
    properties: {
        examples: [
...
,
// src/gitHub/Codeinwp/Nivo-Slider-jQuery.js
{
    properties: {
        link: 'https://github.com/Codeinwp/Nivo-Slider-jQuery',
        name: 'Nivo Slider jQuery Plugin',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/DataTables/Editor-PHP.js
{
    properties: {
        link: 'https://github.com/DataTables/Editor-PHP',
        platform: 'GitHub',
        examples: [
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.DataTable.Editor'
            ]
        ]
    },
    versions: {
        references: [
            'window.jQuery.fn.DataTable.Editor.version'
        ]
    }
}
,
// src/gitHub/DataTables/Responsive.js
{
    properties: {
        link: 'https://github.com/DataTables/Responsive',
        platform: 'GitHub',
        examples: [
            'https://editor.datatables.net/'
        ],
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.DataTable.Responsive'
            ]
        ]
    },
    versions: {
        references: [
            'window.jQuery.fn.DataTable.Responsive.version'
        ]
    }
}
,
...
,
// src/gitHub/FancyGrid/FancyGrid.js
{
    properties: {
        examples: [
    ...
    versions: {
        references: [
            'window.Fancy.version'
        ]
    }
}
,
// src/gitHub/Fantomas42/django-blog-zinnia.js
{
    dependencies: [
...
,
// src/gitHub/FrDH/jQuery.mmenu.js
{
    properties: {
        licenses: {
            commercial: {
    ...
    tests: {
        references: [
            [
                'window.jQuery.mmenu',
                'window.jQuery.mmenu.defaults'
            ]
        ]
    },
    versions: {
        references: [
            'window.jQuery.mmenu.version'
        ]
    }
}
,
...
// src/gitHub/Julienh/Sharrre.js
{
    properties: {
        ...
        link: 'https://github.com/Julienh/Sharrre',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.jQuery.fn.sharrre'
            ]
        ]
    }
}
,
// src/gitHub/KaTeX/KaTeX.js
{
    properties: {
...
,
// src/gitHub/LiranCohen/stickUp.js
{
    properties: {
        examples: [
...
// src/gitHub/MohammadYounes/jquery-scrollLock.js
{
    properties: {
        ...
        link: 'https://github.com/MohammadYounes/jquery-scrollLock',
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.scrollLock',
                'window.jQuery.fn.scrollLock.defaults'
            ]
        ]
    }
}
...
,
// src/gitHub/Ortus-Solutions/ContentBox.js
{
    properties: {
        examples: [
            'https://www.contentboxcms.org/'
        ],
        link: 'https://github.com/Ortus-Solutions/ContentBox',
        name: 'ContentBox',
        platform: 'GitHub',
        type: 'repository'
    },
...
// src/gitHub/Pikaday/Pikaday.js
{
    ...
    tests: {
        references: [
            [
                'window.Pikaday',
                'window.Pikaday.prototype.clear'
            ]
        ]
    }
}
...
,
// src/gitHub/PopupMaker/Popup-Maker.js
{
    properties: {
        examples: [
            'https://www.harbr.com/'
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.popmake',
                'window.jQuery.fn.popmake.animations'
            ]
        ]
    },
    versions: {
...
,
// src/gitHub/StephanWagner/jBox.js
{
    properties: {
        examples: [
...
,
// src/gitHub/Valve/fingerprintjs.js
{
    properties: {
        examples: [
    ...
    tests: {
        references: [
            [
                'window.Fingerprint',
                'window.Fingerprint.prototype.isCanvasSupported'
            ]
        ]
    },
    versions: {
        references: [
            'window.Fingerprint.VERSION'
        ]
    }
}
,
...
,
// src/gitHub/Wisembly/basil.js.js
{
    properties: {
        examples: [
    ...
    tests: {
        references: [
            [
                ...
                'window.simpleStorage.canUse'
            ]
        ]
    },
    versions: {
        references: [
            'window.simpleStorage.version'
        ]
    }
}
,
// src/gitHub/a-jie/Proton.js
{
    properties: {
...
,
// src/gitHub/alvarotrigo/multiscroll.js.js
{
    properties: {
        examples: [
...
// src/gitHub/ampproject/amphtml.js
{
    properties: {
        examples: [
            'https://www.nbcnews.com/news/amp/ncna955931',
        ...
        wikiPedia: {
            load: true,
            title: 'Accelerated_Mobile_Pages'
        }
    },
    tests: {
        references: [
...
,
// src/gitHub/amsul/pickadate.js.js
{
    properties: {
        examples: [
...
,
// src/gitHub/angular-ui/ui-validate.js
{
    properties: {
        examples: [
            'https://my.wealthsimple.com/app/withdrawals'
        ],
        link: 'https://github.com/angular-ui/ui-validate',
        name: 'AngularJS ui-validate',
        platform: 'GitHub',
        tags: [
            'angular'
        ],
...
// src/gitHub/apache/tomcat.js
{
    ...
    properties: {
        ...
        examples: [
            ...
            'http://doc.prestashop.com/dashboard.action;jsessionid=D2D2BD04C126086E8025505137C1FE49',
...
,
// src/gitHub/apollographql/apollo-client.js
{
    properties: {
        examples: [
    ...
    versions: {
        references: [
            'window.__APOLLO_CLIENT__.version'
        ]
    }
}
,
...
,
// src/gitHub/asciidoc/asciidoc.js
{
    properties: {
        examples: [
            'http://asciidoc.org/'
        ],
        link: 'https://github.com/asciidoc/asciidoc',
        name: 'AsciiDoc',
        platform: 'GitHub',
        type: 'repository'
    },
...
,
// src/gitHub/backbone-paginator/backbone.paginator.js
{
    properties: {
        examples: [
            'http://backbone-paginator.github.io/backbone.paginator/examples/client-mode.html'
        ],
        link: 'https://github.com/backbone-paginator/backbone.paginator',
    ...
    tests: {
        references: [
            [
                'window.Backbone.Paginator'
            ],
            [
                'window.Backbone.PageableCollection'
            ]
        ]
    }
}
...
// src/gitHub/balupton/jquery-lightbox.js
{
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.lightbox'
            ]
        ]
    }
}
,
// src/gitHub/balupton/jquery-syntaxhighlighter.js
{
    properties: {
        examples: [
...
// src/gitHub/bas2k/jquery.appear.js
{
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.appear',
                'window.jQuery.fn.appear.checkAll',
                'window.jQuery.fn.appear.checks'
            ]
        ]
    }
}
...
// src/gitHub/bestiejs/punycode.js.js
{
    ...
    tests: {
        references: [
            [
                'window.punycode',
                'window.punycode.ucs2',
                'window.punycode.decode',
                'window.punycode.toASCII'
            ]
        ]
    },
    versions: {
        references: [
            'window.punycode.version'
        ]
    }
}
,
...
// src/gitHub/bgrins/TinyColor.js
{
    ...
    tests: {
        references: [
            [
                'window.tinycolor',
                'window.tinycolor.equals'
            ]
        ]
    }
}
,
// src/gitHub/bgrins/bindWithDelay.js
{
    properties: {
        examples: [
            'https://bgrins.github.io/bindWithDelay/#example'
        ],
        link: 'https://github.com/bgrins/bindWithDelay',
        platform: 'GitHub',
        tags: [
            'events'
        ],
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.bindWithDelay'
            ]
        ]
    }
}
...
,
// src/gitHub/canjs/canjs.js
{
    properties: {
        examples: [
            'https://canjs.com/',
            'https://www.apple.com/ca/shop/refurbished/mac/15-inch'
        ],
        link: 'https://github.com/canjs/canjs',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/carolineschnapp/currencies.js
{
    properties: {
        examples: [
            'https://missionworkshop.com/collections/backpack-accessories/products/internal-tool-roll-backpack-accessory'
        ],
        link: 'https://github.com/carolineschnapp/currencies',
...
,
// src/gitHub/cbeyls/slimbox.js
{
    properties: {
        examples: [
            'http://www.digitalia.be/software/slimbox2/',
            'https://www.soas.ac.uk/courseunits/15PDSC006.html'
        ],
...
,
// src/gitHub/cferdinandi/tabby.js
{
    properties: {
        examples: [
            'http://cferdinandi.github.io/tabby/',
...
,
// src/gitHub/chrishunt/favcount.js
{
    properties: {
        examples: [
    ...
    tests: {
        references: [
            [
                'window.Favcount',
                'window.Favcount.prototype.set'
            ]
        ]
    },
    versions: {
        references: [
            'window.Favcount.VERSION'
        ]
    }
}
,
...
,
// src/gitHub/concrete5/concrete5.js
{
    properties: {
        examples: [
            'https://www.concrete5.org/'
        ],
        link: 'https://github.com/concrete5/concrete5',
        name: 'Concrete5',
        platform: 'GitHub',
        type: 'repository'
    },
...
,
// src/gitHub/danvk/dygraphs.js
{
    properties: {
        examples: [
            'http://dygraphs.com/'
        ],
        link: 'https://github.com/danvk/dygraphs',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.Dygraph',
                'window.Dygraph.PLUGINS'
            ]
        ]
    },
    versions: {
        references: [
            'window.Dygraph.VERSION'
        ]
    }
}
,
...
,
// src/gitHub/dbtek/angular-aside.js
{
    properties: {
        examples: [
            'https://oscar.go.com/'
        ],
        link: 'https://github.com/dbtek/angular-aside',
        platform: 'GitHub',
        tags: [
            'angular'
        ],
...
,
// src/gitHub/designmodo/Flat-UI.js
{
    properties: {
        examples: [
...
,
// src/gitHub/dubrox/Multiple-Dates-Picker-for-jQuery-UI.js
{
    properties: {
        examples: [
    ...
    versions: {
        references: [
            'window.jQuery.multiDatesPicker.version'
        ]
    }
}
,
...
,
// src/gitHub/emn178/js-sha256.js
{
    properties: {
        examples: [
...
// src/gitHub/epochjs/epoch.js
{
    ...
    properties: {
        ...
        link: 'https://github.com/epochjs/epoch',
        name: 'Epoch',
        platform: 'GitHub',
        type: 'repository'
    },
...
,
// src/gitHub/evoluteur/colorpicker.js
{
    properties: {
        alternatives: [
...
,
// src/gitHub/fat/bean.js
{
    properties: {
        link: 'https://github.com/fat/bean',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/fdansv/marginotes.js
{
    properties: {
        examples: [
            'http://francisco.dance/'
        ],
...
,
// src/gitHub/firebase/angularfire.js
{
    properties: {
        examples: [
            'https://angularjs.org/'
        ],
        link: 'https://github.com/firebase/angularfire',
        platform: 'GitHub',
        tags: [
            'angular'
        ],
...
// src/gitHub/flesler/jquery.serialScroll.js
{
    properties: {
        ...
        link: 'https://github.com/flesler/jquery.serialScroll',
        platform: 'GitHub',
        tags: [
            'scrolling'
        ],
...
,
// src/gitHub/ftlabs/ftscroller.js
{
    properties: {
        examples: [
            'https://labs.ft.com/ftscroller/examples/verticalcontinuous.html'
        ],
        link: 'https://github.com/ftlabs/ftscroller',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/ganlanyuan/tiny-slider.js
{
    properties: {
        examples: [
    ...
    tests: {
        references: [
            [
                'window.tns',
                'window.tns.prototype',
                'window.tns.prototype.constructor'
            ]
        ]
    }
}
...
,
// src/gitHub/googlemaps/js-marker-clusterer.js
{
    properties: {
        examples: [
...
,
// src/gitHub/greggman/twgl.js.js
{
    properties: {
        examples: [
            'http://twgljs.org/'
    ...
    tests: {
        references: [
            [
                'window.twgl',
                'window.twgl.getContext'
            ]
        ]
    }
}
,
// src/gitHub/gregjacobs/Autolinker.js.js
{
    properties: {
    ...
    tests: {
        references: [
            [
                'window.Autolinker',
                'window.Autolinker.Util'
            ]
        ]
    },
    versions: {
        references: [
            'window.Autolinker.version'
        ]
    }
}
,
...
,
// src/gitHub/hakimel/stroll.js.js
{
    properties: {
...
// src/gitHub/hay/stapes.js
{
    ...
    tests: {
        references: [
            [
                'window.Stapes',
                'window.Stapes.mixinEvents'
            ]
        ]
    },
    versions: {
        references: [
            'window.Stapes.version'
        ]
    }
}
,
...
,
// src/gitHub/highchartTable/jquery-highchartTable-plugin.js
{
    properties: {
        examples: [
...
,
// src/gitHub/hilongjw/vue-progressbar.js
{
    dependencies: [
    ...
    properties: {
        ...
        link: 'https://github.com/hilongjw/vue-progressbar',
...
// src/gitHub/infusion/Fraction.js.js
{
    ...
    tests: {
        references: [
            [
                'window.Fraction',
                'window.Fraction.DivisionByZero'
            ]
        ]
    }
}
...
// src/gitHub/infusion/jQuery-xcolor.js
{
    ...
    tests: {
        references: [
            [
                'window.jQuery.xcolor',
                'window.jQuery.fn.colorize'
            ]
        ]
    }
}
,
// src/gitHub/insites/cookieconsent.js
{
    properties: {
...
,
// src/gitHub/jacomyal/conrad.js.js
{
    properties: {
    ...
    tests: {
        references: [
            [
                'window.conrad',
                'window.conrad.addJob'
            ]
        ]
    },
    versions: {
        references: [
            'window.conrad.version'
        ]
    }
}
,
...
,
// src/gitHub/jakerella/jquery-mockjax.js
{
    properties: {
        examples: [
...
,
// src/gitHub/jasonmayes/Twitter-Post-Fetcher.js
{
    properties: {
        examples: [
            'https://www.grantedclothing.com/collections/cbc?ls=en'
        ],
        link: 'https://github.com/jasonmayes/Twitter-Post-Fetcher',
...
,
// src/gitHub/jcubic/jquery.terminal.js
{
    properties: {
        examples: [
    ...
    tests: {
        references: [
            [
                'window.jQuery.terminal',
                'window.jQuery.terminal.color_names',
...
// src/gitHub/jeresig/jquery.hotkeys.js
{
    ...
    tests: {
        references: [
            [
                'window.jQuery.hotkeys',
                'window.jQuery.hotkeys.specialKeys'
            ]
        ]
    },
    versions: {
        references: [
            'window.jQuery.hotkeys.version'
        ]
    }
}
,
...
,
// src/gitHub/jmdobry/angular-cache.js
{
    properties: {
        examples: [
            'https://analytics.google.com/analytics/web/#/report-home/a35893957w63834918p65499463'
        ],
        link: 'https://github.com/jmdobry/angular-cache',
        platform: 'GitHub',
        tags: [
            'angular'
        ],
...
,
// src/gitHub/jonathantneal/svg4everybody.js
{
    properties: {
        alternatives: [
            'https://jonathantneal.github.io/svg4everybody/',
            'https://www.prospects.ac.uk/universities/soas-university-of-london-3869/department-of-development-studies-10080/courses/violence-conflict-and-development-palestine-pathway-116816'
        ],
        link: 'https://github.com/jonathantneal/svg4everybody',
...
,
// src/gitHub/josecebe/twbs-pagination.js
{
    properties: {
        examples: [
        ...
        link: 'https://github.com/josecebe/twbs-pagination',
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.twbsPagination',
                'window.jQuery.fn.twbsPagination.defaults'
            ]
        ]
    },
    versions: {
        references: [
            'window.jQuery.fn.twbsPagination.version'
        ]
    }
}
,
...
// src/gitHub/jquery/jquery-color.js
{
    ...
    tests: {
        references: [
            [
                'window.jQuery.Color',
                'window.jQuery.Color.fn',
                'window.jQuery.Color.fn.parse'
            ]
        ]
    }
}
...
,
// src/gitHub/juliangarnier/anime.js
{
    properties: {
        examples: [
            'http://animejs.com/',
...
,
// src/gitHub/karacas/imgLiquid.js
{
    properties: {
        examples: [
            'http://www.lse.ac.uk/iga/initiatives/global-migration'
        ],
        link: 'https://github.com/karacas/imgLiquid',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            ...
            [
                'window.jQuery.fn.imgLiquid'
            ]
        ]
    },
    versions: {
        references: [
            'window.imgLiquid.VER'
        ]
    }
}
,
...
,
// src/gitHub/kartograph/kartograph.js.js
{
    properties: {
        examples: [
            'http://kartograph.org/'
        ],
        link: 'https://github.com/kartograph/kartograph.js',
        platform: 'GitHub',
        tags: [
            'maps'
        ],
...
,
// src/gitHub/lcdsantos/jquery-drawsvg.js
{
    properties: {
        examples: [
            'http://leocs.me/jquery-drawsvg/'
        ],
        link: 'https://github.com/lcdsantos/jquery-drawsvg',
        name: 'jQuery DrawSVG',
        platform: 'GitHub',
        type: 'repository'
    },
...
// src/gitHub/less/less.js.js
{
    ...
    tests: {
        references: [
            [
                'window.less',
                'window.less.AbstractFileManager'
            ]
        ]
    },
    versions: {
        statements: [
            'window.less.version.join(\'.\')'
        ]
    }
}
,
...
,
// src/gitHub/louisremi/jquery-smartresize.js
{
    properties: {
        examples: [
    ...
    tests: {
        references: [
            [
                'window.jQuery.event.special.debouncedresize'
            ],
            [
                'window.jQuery.event.special.throttledresize'
            ]
        ]
    }
}
...
,
// src/gitHub/marceljuenemann/angular-drag-and-drop-lists.js
{
    properties: {
        examples: [
            'https://analytics.google.com/analytics/web/#/report-home/a35893957w63834918p65499463'
        ],
        link: 'https://github.com/marceljuenemann/angular-drag-and-drop-lists',
        platform: 'GitHub',
        tags: [
            'angular',
            'drag-and-drop'
...
,
// src/gitHub/marcuswestin/store.js.js
{
    properties: {
        examples: [
            'https://www.twilio.com/console'
...
,
// src/gitHub/marionettejs/backbone.wreqr.js
{
    properties: {
        examples: [
            'https://www.thebay.com/'
...
,
// src/gitHub/markgoodyear/scrollup.js
{
    properties: {
        examples: [
            'https://markgoodyear.com/labs/scrollup/'
        ],
        link: 'https://github.com/markgoodyear/scrollup',
        name: 'ScrollUp',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.jQuery.fn.scrollUp'
            ]
        ]
    }
}
,
// src/gitHub/marklagendijk/jquery.tabbable.js
{
    properties: {
        examples: [
            'https://www.kickstarter.com/'
        ],
        link: 'https://github.com/marklagendijk/jquery.tabbable',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.jQuery.focusNext',
                'window.jQuery.focusPrev',
                'window.jQuery.tabNext',
                'window.jQuery.tabPrev'
            ]
        ]
    }
}
...
,
// src/gitHub/mattboldt/typed.js.js
{
    properties: {
        examples: [
...
,
// src/gitHub/mavoweb/mavo.js
{
    properties: {
        link: 'https://github.com/mavoweb/mavo',
        platform: 'GitHub',
        tags: [
            'search'
        ],
...
,
// src/gitHub/mobify/mobifyjs.js
{
    properties: {
        examples: [
            'https://www.merlinspotions.com/'
        ],
        link: 'https://github.com/mobify/mobifyjs',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
// src/gitHub/muicss/mui.js
{
    properties: {
        ...
        name: 'MUI: Material Design CSS Framework',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/naptha/tesseract.js.js
{
    properties: {
...
,
// src/gitHub/necolas/normalize.css.js
{
    properties: {
        examples: [
            'https://milligram.io/',
...
,
// src/gitHub/neveldo/jQuery-Mapael.js
{
    properties: {
        examples: [
    ...
    tests: {
        references: [
            [
                'window.jQuery.mapael',
                'window.jQuery.fn.mapael'
            ]
        ]
    },
    versions: {
        references: [
            'window.jQuery.mapael.version'
        ]
    }
}
,
...
,
// src/gitHub/ngryman/jquery.finger.js
{
    properties: {
        examples: [
            'https://www.altitude-sports.com/collections/all/brands-oakley'
        ],
        link: 'https://github.com/ngryman/jquery.finger',
        platform: 'GitHub',
        tags: [
            'touch-events'
        ],
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.tap',
                'window.jQuery.fn.doubletap',
                'window.jQuery.fn.press',
                'window.jQuery.fn.drag',
                'window.jQuery.fn.flick'
            ]
        ]
    }
}
...
,
// src/gitHub/nnattawat/slideReveal.js
{
    properties: {
...
,
// src/gitHub/nosir/obelisk.js.js
{
    properties: {
...
,
// src/gitHub/notwaldorf/emoji-translate.js
{
    properties: {
        link: 'https://github.com/notwaldorf/emoji-translate',
        platform: 'GitHub',
        examples: [
...
,
// src/gitHub/oriongunning/gridder.js
{
    properties: {
        examples: [
            'http://oriongunning.github.io/gridder/'
        ],
        link: 'https://github.com/oriongunning/gridder',
        name: 'jQuery Gridder',
        platform: 'GitHub',
        type: 'repository'
    },
...
,
// src/gitHub/padams/Open-Web-Analytics.js
{
    properties: {
        examples: [
...
,
// src/gitHub/paypal/paypal-checkout.js
{
    properties: {
        examples: [
...
,
// src/gitHub/pbakaus/scroller.js
{
    properties: {
        examples: [
            'http://zynga.github.io/scroller/demo/easyscroller.html'
        ],
        link: 'https://github.com/pbakaus/scroller',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/pixelcog/parallax.js.js
{
    properties: {
        examples: [
            'http://pixelcog.github.io/parallax.js/'
        ],
        link: 'https://github.com/pixelcog/parallax.js',
        platform: 'GitHub',
        tags: [
            'parallax',
            'scrolling'
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.parallax',
                'window.jQuery.fn.parallax.noConflict'
            ]
        ]
    }
}
...
,
// src/gitHub/plaid/link.js
{
    properties: {
        examples: [
            'https://my.wealthsimple.com/app/withdrawals'
        ],
        link: 'https://github.com/plaid/link',
        name: 'Plaid',
        platform: 'GitHub',
        type: 'repository'
    },
...
// src/gitHub/prrashi/rateYo.js
{
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.rateYo'
            ]
        ]
    }
}
,
// src/gitHub/pupunzi/jquery.mb.YTPlayer.js
{
    properties: {
        examples: [
...
,
// src/gitHub/pupunzi/jquery.mb.extruder.js
{
    properties: {
        examples: [
            'https://pupunzi.com/mb.components/mb.extruder/demo/demo.html'
        ],
        link: 'https://github.com/pupunzi/jquery.mb.extruder',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.jQuery.fn.buildMbExtruder'
            ]
        ]
    },
    versions: {
        references: [
            'window.jQuery.mbExtruder.version'
        ]
    }
}
,
    ...
    tests: {
        references: [
            [
                'window.Pusher',
                'window.Pusher.HTTP',
                'window.Pusher.Base64'
            ]
        ]
    },
    versions: {
        references: [
            'window.Pusher.VERSION'
        ]
    }
}
,
// src/gitHub/python/cpython.js
{
    properties: {
        donate: {
            link: 'https://www.python.org/psf/donations/'
        },
        examples: [
            'https://www.imi-n.org/publications/money-matters-the-role-of-funding-in-migration-governance'
        ],
...
,
// src/gitHub/qTip2/qTip2.js
{
    properties: {
        donate: {
            link: 'http://qtip2.com/donate'
        },
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.qtip',
                'window.jQuery.fn.qtip.defaults'
            ]
        ]
    },
    versions: {
        references: [
            'window.jQuery.fn.qtip.version'
        ]
    }
}
,
...
,
// src/gitHub/rstaib/jquery-bootgrid.js
{
    properties: {
        examples: [
            'http://www.jquery-bootgrid.com/Examples'
        ],
        link: 'https://github.com/rstaib/jquery-bootgrid',
        name: 'jQuery Bootgrid Plugin',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
...
,
// src/gitHub/schteppe/p2.js.js
{
    properties: {
        examples: [
            'http://schteppe.github.io/p2.js/demos/buoyancy.html'
        ],
        link: 'https://github.com/schteppe/p2.js',
        platform: 'GitHub',
        tags: [
            'animation',
            'svg'
...
,
// src/gitHub/scottcheng/cropit.js
{
    properties: {
        examples: [
...
,
// src/gitHub/simsalabim/sisyphus.js
{
    properties: {
        examples: [
...
,
// src/gitHub/smurfy/cloud-zoom.js
{
    properties: {
        examples: [
            'https://twentyonetoys.ca/'
        ],
        link: 'https://github.com/smurfy/cloud-zoom',
        name: 'CloudZoom',
        platform: 'GitHub',
        type: 'repository'
    },
...
,
// src/gitHub/tabalinas/jsgrid.js
{
    properties: {
        examples: [
    ...
    tests: {
        references: [
            [
                'window.jsGrid',
                'window.jsGrid.setDefaults'
            ],
            [
                'window.jQuery.fn.jsGrid'
            ]
        ]
    },
    versions: {
        references: [
            'window.jsGrid.version'
        ]
    }
}
,
// src/gitHub/tabalinas/jssocials.js
{
    properties: {
        examples: [
            'http://js-socials.com/demos/'
        ],
        link: 'https://github.com/tabalinas/jssocials',
        name: 'jsSocials',
        platform: 'GitHub',
        type: 'repository'
    },
...
,
// src/gitHub/telerik/kendo-ui-core.js
{
    properties: {
        examples: [
...
,
// src/gitHub/thednp/kute.js.js
{
    properties: {
        examples: [
            'http://thednp.github.io/kute.js/'
        ],
        link: 'https://github.com/thednp/kute.js',
        platform: 'GitHub',
        tags: [
            'animation',
            'svg'
...
,
// src/gitHub/thompsonemerson/zoomove.js
{
    properties: {
        examples: [
            'http://thompsonemerson.github.io/zoomove/'
    ...
    tests: {
        references: [
            [
                'window.window.jQuery.fn.ZooMove'
            ]
        ]
    }
}
,
// src/gitHub/thorst/jquery-idletimer.js
{
    properties: {
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.idleTimer'
            ]
        ]
    }
}
,
// src/gitHub/tildeio/rsvp.js.js
{
    properties: {
        examples: [
            'https://addyosmani.com/basket.js/'
...
// src/gitHub/trentrichardson/jQuery-Timepicker-Addon.js
{
    ...
    versions: {
        references: [
            'window.jQuery.timepicker.version'
        ]
    }
}
,
...
,
// src/gitHub/tuupola/jquery_chained.js
{
    properties: {
        link: 'https://github.com/tuupola/jquery_chained',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.jQuery.fn.chained',
                'window.jQuery.fn.chained.defaults',
                'window.jQuery.fn.chainedTo'
            ],
            [
                'window.Zepto.fn.chained',
                'window.Zepto.fn.chained.defaults',
                'window.Zepto.fn.chainedTo'
            ]
        ]
    }
}
...
,
// src/gitHub/vast-engineering/jquery-popup-overlay.js
{
    properties: {
        examples: [
...
,
// src/gitHub/vitalets/x-editable.js
{
    properties: {
        examples: [
            'http://vitalets.github.io/x-editable/demo.html'
        ],
        link: 'https://github.com/vitalets/x-editable',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.jQuery.fn.editable',
                'window.jQuery.fn.editableContainer',
                'window.jQuery.fn.editableform'
            ]
        ]
    }
}
...
,
// src/gitHub/walmik/timer.jquery.js
{
    properties: {
        examples: [
            'https://jquerytimer.com/'
        ],
        link: 'https://github.com/walmik/timer.jquery',
        name: 'jQuery Timer plugin',
        platform: 'GitHub',
        tags: [
            'datetime'
        ],
...
,
// src/gitHub/wikimedia/jquery.i18n.js
{
    properties: {
        donate: {
...
// src/gitHub/wilq32/jqueryrotate.js
{
    ...
    tests: {
        references: [
            [
                'window.jQuery.fn.rotate',
                'window.jQuery.fn.getRotateAngle'
            ]
        ]
    }
}
...
{
    properties: {
        link: 'https://github.com/winmarkltd/BootstrapFormHelpers',
        platform: 'GitHub',
        examples: [
            'https://www.namecheap.com/',
            'http://bootstrapformhelpers.com/colorpicker/'
        ],
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.jQuery.fn.bfhcolorpicker'
            ],
            [
                'window.jQuery.fn.bfhcountries'
            ],
            [
                'window.jQuery.fn.bfhcurrencies'
            ],
            [
                'window.jQuery.fn.bfhdatepicker'
            ],
            [
                'window.jQuery.fn.bfhfonts'
            ],
            [
                'window.jQuery.fn.bfhfontsizes'
            ],
            [
                'window.jQuery.fn.bfhgooglefonts'
            ],
            [
                'window.jQuery.fn.bfhlanguages'
            ],
            [
                'window.jQuery.fn.bfhnumber'
            ],
            [
                'window.jQuery.fn.bfhphone'
            ],
            [
                'window.jQuery.fn.bfhselectbox'
            ],
            [
                'window.jQuery.fn.bfhslider'
            ],
            [
                'window.jQuery.fn.bfhstates'
            ],
            [
                'window.jQuery.fn.bfhtimepicker'
            ],
            [
                'window.jQuery.fn.bfhtimezones'
            ]
        ]
    }
}
,
// src/gitHub/wmh/jquery-scrollbox.js
{
    properties: {
        examples: [
            'http://wmh.github.io/jquery-scrollbox/'
        ],
        link: 'https://github.com/wmh/jquery-scrollbox',
...
// src/gitHub/wycats/handlebars.js.js
{
    properties: {
        examples: [
            'https://deadline.com/2018/08/roma-alfonso-cuaron-venice-film-festival-netflix-interview-1202455061/'
        ],
...
,
// src/gitHub/xdamman/selection-sharer.js
{
    properties: {
        examples: [
            'https://www.thebeaverton.com/'
        ],
        link: 'https://github.com/xdamman/selection-sharer',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                'window.SelectionSharer'
            ],
            [
                'window.jQuery.fn.SelectionSharer'
            ],
            [
                'window.thbSelectionSharer'
            ],
            [
                'window.jQuery.fn.thbSelectionSharer'
            ]
        ]
    }
}
...
,
// src/gitHub/yckart/jquery.base64.js.js
{
    properties: {
        examples: [
            'http://yckart.github.io/jquery.base64.js/'
        ],
        link: 'https://github.com/yckart/jquery.base64.js',
        platform: 'GitHub',
        type: 'repository'
    },
    tests: {
        references: [
            [
                ...
                'window.jQuery.base64.atob',
                'window.jQuery.base64.btoa',
                'window.jQuery.base64.utf8encode'
            ]
        ]
    }
}
...
,
// src/gitHub/zuk/jquery.inview.js
{
    properties: {
        examples: [
